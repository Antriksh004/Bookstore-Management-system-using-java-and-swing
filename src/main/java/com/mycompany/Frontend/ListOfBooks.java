...
public class ListOfBooks extends javax.swing.JFrame {
    ...
    public ListOfBooks(String username, String userId, String noOfBooksIssued, String noOfBooksDue) {
        this.username = username;
        this.userId = userId;
        this.noOfBooksIssued = noOfBooksIssued;
        this.noOfBooksDue = noOfBooksDue;
        initComponents();
        DefaultTableModel dtm = (DefaultTableModel) BooksList.getModel();
        List<BooksComingSoon> books = BookController.getBooksComingSoon();
        for(BooksComingSoon bcs : books){
            dtm.addRow(new Object[]{bcs.bookname, bcs.authorName, bcs.publication, bcs.expectedDate});
        }
    }
    ...
    private void initComponents() {
        ...
        BooksList.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Book Name", "Author", "Publication", "Expected Date"
            }
        ));
