...
public class ListAllBooks extends javax.swing.JFrame {
    ...
    public ListAllBooks() {
        initComponents();
        DefaultTableModel dtm = (DefaultTableModel) BooksListTable.getModel();
        List<BookModel> books = BookController.getBooks();
        for(BookModel bm : books){
            dtm.addRow(new Object[]{bm.name, bm.author, bm.publication, bm.createdAt});
        }
    }
